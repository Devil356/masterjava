...
/**
 * XSL - семейство языков (XPath, XSL-FO, XSLT). XSLT - язык преобразования XML док-тов
 */
public class XsltProcessor {
    ...
    public XsltProcessor(Reader xslReader) {
        try {
            ...
            throw new IllegalStateException("XSLT transformer creation failed: " + e.getMessage());
        }
    }
